...
namespace Etron_SharePoint.WebParts.MyTask
{
    [ToolboxItemAttribute(false)]
    public partial class MyTask : WebPart
    {
        ...
        public SPGridView ConfigSpGridView(SPGridView spGridView)
        {
            ...
            //绑定数据源
            spGridView.DataSourceID = "task_ObjectDataSource";//关联ObjectDataSource ID
            spGridView.DataBind();
        ...
        {
            var odsDataSource = new ObjectDataSource
            {
                ID = "task_ObjectDataSource",
                TypeName = this.GetType().FullName + "," + this.GetType().Assembly.FullName,
        ...
        public DataTable  GetDataSource()
        {
            ...
            return RetriveData.GetMyTask(currentUser);
        }
    }
}
