...
namespace Etron_SharePoint.WebParts.MyApply
{
    ...
    public partial class MyApply : WebPart
    {
        ...
        public SPGridView ConfigSpGridView(SPGridView spGridView)
        {
            ...
            //绑定数据源
            spGridView.DataSourceID = "apply_ObjectDataSource";//关联ObjectDataSource ID
            spGridView.DataBind();
        ...
        public ObjectDataSource CreateDataSource()
        {
            ...
            odsDataSource.ID = "apply_ObjectDataSource";
        ...
        public DataTable GetDataSource()
        {
            ...
            return RetriveData.GetMyApply(currentUser);
        }
    }
}
